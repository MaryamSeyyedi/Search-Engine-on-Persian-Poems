...
for item in files_in_basepath:
    ...
    save_path = 'C:/Users/Maryam/Desktop/Term1/IR/HW1_amali/dataset/poems/hazm/NTRS_hazm/'
    ...
    for item in files_in_basepath:
        ...
        text = "\n".join(stemmed_words)
        # save preprocessed file
        save_path = 'C:/Users/Maryam/Desktop/Term1/IR/HW1_amali/dataset/queries/hazm/NTRS_hazm/'
        completeName = os.path.join(save_path, item.name)
