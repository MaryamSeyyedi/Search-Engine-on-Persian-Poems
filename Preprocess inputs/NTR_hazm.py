...
for item in files_in_basepath:
    ...
    save_path = 'C:/Users/Maryam/Desktop/Term1/IR/HW1_amali/dataset/poems/hazm/NTR_hazm/'
...
for item in files_in_basepath:
    ...
    text = "\n".join(tokenized_words_after_removing)
    # save preprocessed file
    save_path = 'C:/Users/Maryam/Desktop/Term1/IR/HW1_amali/dataset/queries/hazm/NTR_hazm/'
    completeName = os.path.join(save_path, item.name)
